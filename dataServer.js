...
app.get('/main/:id',mainApi.getMain);
...
app.get('/compets/:id', competApi.getAllCompet);//공모전 정보 가져오기. 넣는건 크롤링서버에서 함
app.get('/compets/select/:id',competApi.getSelectCompet); //선택된 공모전 정보 가져오기 (공모전 해당 팀 정보와 함께)

//북마크 처리 api
var bookmarkApi = require('./bookmark');
app.post('/bookmark',bookmarkApi.putBookmark); //팀 북마크 추가
app.post('/bookmark/delete',bookmarkApi.deleteBookmark); //팀 북마크 삭제
app.post('/bookmark/compet',bookmarkApi.putCompetBookmark); //공모전 북마크 추가
app.post('/bookmark/compet/delete',bookmarkApi.deleteCompetBookmark); //공모전 북마크 삭제
...
app.get('/search/filtercompets/:id',searchApi.getFilterCompet);//프로필 검색 시 필터링하고 띄우기
app.get('/search/compets/:id',searchApi.getSearchCompet);//프로필 검색하기
